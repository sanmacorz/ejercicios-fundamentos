...
def modifica_foco(campo_actual):
    ...
    if estado == "EN CURSO":
        ...
        if estado == "OK":
            etiqueta = Label(
                text="¡PRUEBA SUPERADA!", fg="green", font=("Arial", 20, "bold")
            )
        else:
            etiqueta = Label(
                text="¡PRUEBA NO SUPERADA!", fg="red", font=("Arial", 20, "bold")
            )
...
campo1 = Entry(
    font=("Arial", 24, "bold"), bd=5, highlightcolor="red", highlightthickness=2
)
campo2 = Entry(
    font=("Arial", 24, "bold"), bd=5, highlightcolor="red", highlightthickness=2
)
